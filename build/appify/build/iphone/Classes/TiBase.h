...
// in simulator we redefine to format for progress_bar_test Developer console
...
{\
	NSString * exceptionName = [@"org.progress_bar_test." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.progress_bar_test";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIprogress_bar_testNativeItemNone = -1, 
	UIprogress_bar_testNativeItemSpinner = -2,
	UIprogress_bar_testNativeItemProgressBar = -3,
	
	UIprogress_bar_testNativeItemSlider = -4,
	UIprogress_bar_testNativeItemSwitch = -5,
	UIprogress_bar_testNativeItemMultiButton = -6,
	UIprogress_bar_testNativeItemSegmented = -7,
	
	UIprogress_bar_testNativeItemTextView = -8,
	UIprogress_bar_testNativeItemTextField = -9,
	UIprogress_bar_testNativeItemSearchBar = -10,
	
	UIprogress_bar_testNativeItemPicker = -11,
	UIprogress_bar_testNativeItemDatePicker = -12,
	
	UIprogress_bar_testNativeItemInfoLight = -13,
	UIprogress_bar_testNativeItemInfoDark = -14,
	
	UIprogress_bar_testNativeItemDisclosure = -15,
	
	UIprogress_bar_testNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all progress_bar_test instances of
