...
/**
 Base class for all progress_bar_test views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the progress_bar_test view hierarchy (such as wrapped iOS UIViews) was touched.
