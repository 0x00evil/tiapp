...
@interface progress_bar_testObject : KrollCoverageObject {
#else
@interface progress_bar_testObject : KrollObject {
#endif
@private
...
extern NSString * progress_bar_test$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	progress_bar_testObject *_progress_bar_test;
    KrollObject* console;
	BOOL shutdown;
