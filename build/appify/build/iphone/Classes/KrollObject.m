...
//@interface progress_bar_testObject : NSObject
//@end

@interface progress_bar_testObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[progress_bar_testObject class]])
		{
			for (NSString *key in [[(progress_bar_testObject*)o modules] allKeys])
			{
