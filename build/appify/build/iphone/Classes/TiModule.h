...
/**
 The base class for all progress_bar_test modules
 */
...
/**
 progress_bar_test Platform calls this method on startup.
 */
-(void)startup;

/**
 progress_bar_test Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 progress_bar_test Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 progress_bar_test Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 progress_bar_test Platform calls this method on resume.
 @param sender The sender of the event.
 */
