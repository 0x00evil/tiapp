 ...
 * to send analytic data that can be viewed on the progress_bar_test Dashboard.
 *
 * For information on getting started with progress_bar_test Platform Services,
