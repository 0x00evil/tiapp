...
TiShadow.Appify = "progress_bar_test";
var Compression = require('ti.compression');
require("/lib/ti-mocha");

// If new install clear cache
if (Ti.App.Properties.getString("tishadow::container_version",0) !== "1440728291746") {
  TiShadow.clearCache(true);
  Ti.App.Properties.setString("tishadow::container_version","1440728291746"); 
}


// Need to unpack the bundle on a first load;
var path_name = "progress_bar_test".replace(/ /g,"_");
